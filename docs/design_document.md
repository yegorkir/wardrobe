...
**Пояснение:** SWAP отключён в MVP через явный флаг конфигурации (`swap_enabled = false`), чтобы отпускание всегда означало “положить или уронить”, без скрытой замены предметов.

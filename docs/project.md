...
- [Technical Design Document](technical_design_document.md) — подробное описание архитектуры, подсистем, данных и плана итераций для вертикального среза «Магического гардероба».

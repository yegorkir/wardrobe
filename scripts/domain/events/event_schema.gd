...
const EVENT_ITEM_DROPPED := StringName("item_dropped")
const EVENT_ITEM_QUALITY_CHANGED := StringName("item_quality_changed")

const EVENT_DESK_CONSUMED_ITEM := StringName("desk_consumed_item")
const EVENT_DESK_SPAWNED_ITEM := StringName("desk_spawned_item")
const EVENT_DELIVER_TO_CLIENT_ATTEMPT := StringName("deliver_to_client_attempt")
const EVENT_DELIVER_RESULT_ACCEPT_CONSUME := StringName("deliver_result_accept_consume")
const EVENT_DELIVER_RESULT_REJECT_RETURN := StringName("deliver_result_reject_return")
...
const EVENT_LIGHT_ADJUSTED := StringName("light_adjusted")
const EVENT_LIGHT_TOGGLED := StringName("light_toggled")
...
const PAYLOAD_OLD_VALUE := StringName("old_value")
const PAYLOAD_NEW_VALUE := StringName("new_value")
const PAYLOAD_SOURCE := StringName("source")

const PAYLOAD_DESK_ID := StringName("desk_id")
const PAYLOAD_SERVICE_POINT_ID := StringName("service_point_id")
const PAYLOAD_ITEM_INSTANCE_ID := StringName("item_instance_id")
const PAYLOAD_ITEM_KIND := StringName("item_kind")
const PAYLOAD_CONSUME_KIND := StringName("consume_kind")
const PAYLOAD_REASON_CODE := StringName("reason_code")
const PAYLOAD_PATIENCE_DELTA := StringName("patience_delta")
const PAYLOAD_CLIENT_ID := StringName("client_id")
const PAYLOAD_CLIENT_INSTANCE_ID := StringName("client_instance_id")
const PAYLOAD_CLIENT_SLOT_ID := StringName("client_slot_id")
const PAYLOAD_DESK_SLOT_ID := StringName("desk_slot_id")
const PAYLOAD_CLIENT_PHASE := StringName("client_phase")
const PAYLOAD_EVENT_ID := StringName("event_id")
const PAYLOAD_AMOUNT := StringName("amount")
...
const PAYLOAD_CHECKIN_DONE := StringName("checkin_done")
const PAYLOAD_CHECKOUT_DONE := StringName("checkout_done")
const PAYLOAD_TARGET_CHECKIN := StringName("target_checkin")
const PAYLOAD_TARGET_CHECKOUT := StringName("target_checkout")
const PAYLOAD_SOURCE_ID := StringName("source_id")
const PAYLOAD_OPEN_RATIO := StringName("open_ratio")
const PAYLOAD_IS_ON := StringName("is_on")
const PAYLOAD_ROW_INDEX := StringName("row_index")
...
const REASON_WRONG_ITEM := StringName("wrong_item")
